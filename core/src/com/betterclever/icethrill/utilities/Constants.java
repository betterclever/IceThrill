...
public class Constants {
    ...
    public static final Sprite MAIN_SCREEN_BACKGROUND = new Sprite(new Texture("ice2back.jpg"));
    public static final Sound CANNON_NORMAL_SOUND = Gdx.audio.newSound(Gdx.files.internal("cannon_sound.mp3"));
    public static final Sound CANNON_SUPER_SOUND = Gdx.audio.newSound(Gdx.files.internal("cannon_super.mp3"));
